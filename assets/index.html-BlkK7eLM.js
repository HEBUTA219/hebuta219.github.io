import{_ as n,c as a,b as i,o as l}from"./app-BP6yIk4T.js";const e={};function p(d,s){return l(),a("div",null,s[0]||(s[0]=[i(`<p>制作时环境： jdk1.8 mvn nodejs18.17.0 maven git</p><p>运行时环境：Docker 、Docker Compose version v2.29.7</p><h1 id="一、制作脚本目录结构" tabindex="-1"><a class="header-anchor" href="#一、制作脚本目录结构"><span>一、制作脚本目录结构</span></a></h1><blockquote><p>当前目录用于制作安装包</p></blockquote><h3 id="_1-本地目录结构" tabindex="-1"><a class="header-anchor" href="#_1-本地目录结构"><span>1 本地目录结构</span></a></h3><p>docker # 根目录，用于存放所有与镜像制作相关的文件和子目录</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>├── minio  # 用于构建 MinIO 相关镜像的目录</span></span>
